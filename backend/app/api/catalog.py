...
async def list_merchants(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.catalog", function_name="list_merchants")
        raise
...
async def list_branches(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.catalog", function_name="list_branches")
        raise
...
async def list_categories(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.catalog", function_name="list_categories")
        raise
...
async def list_products(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.catalog", function_name="list_products")
        raise
...
async def calculate_payment(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.catalog", function_name="calculate_payment")
        raise

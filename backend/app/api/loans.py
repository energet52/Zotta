...
async def parse_id_consumer(
    ...
    try:
        ...
        await log_error(e, db=None, module="api.loans", function_name="parse_id_consumer")
        raise
...
async def get_profile(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="get_profile")
        raise
...
async def update_profile(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="update_profile")
        raise
...
async def create_application(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="create_application")
        raise
...
async def list_applications(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="list_applications")
        raise
...
async def get_application(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="get_application")
        raise
...
async def update_application(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="update_application")
        raise
...
async def submit_application(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="submit_application")
        raise
...
async def submit_with_consent(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="submit_with_consent")
        raise
...
async def upload_document(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="upload_document")
        raise
...
async def list_documents(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="list_documents")
        raise
...
async def download_document(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="download_document")
        raise
...
async def delete_document(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="delete_document")
        raise
...
async def accept_counterproposal(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="accept_counterproposal")
        raise
...
async def reject_counterproposal(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="reject_counterproposal")
        raise
...
async def sign_contract(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="sign_contract")
        raise
...
async def accept_offer(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="accept_offer")
        raise
...
async def download_consent_pdf(
    ...
    * Any staff member (admin / underwriter)
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="download_consent_pdf")
        raise
...
async def list_references(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="list_references")
        raise
...
async def add_reference(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="add_reference")
        raise
...
async def update_reference(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="update_reference")
        raise
...
async def delete_reference(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="delete_reference")
        raise
...
async def list_comments(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="list_comments")
        raise
...
async def add_comment(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="add_comment")
        raise
...
async def get_message_notifications(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="get_message_notifications")
        raise
...
async def mark_notifications_read(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="mark_notifications_read")
        raise
...
async def mark_application_comments_read(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="mark_application_comments_read")
        raise
...
async def get_collection_messages(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="get_collection_messages")
        raise
...
async def get_application_collection_messages(
    ...
    try:
        ...
        await log_error(e, db=db, module="api.loans", function_name="get_application_collection_messages")
        raise
